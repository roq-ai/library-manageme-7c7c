...
type ColumnType = ColumnDef<LibraryInterface, unknown>;
...
export function LibraryListPage(props: LibraryListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<LibraryInterface>>(
    () => `/libraries?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/libraries/view/${record.id}`} passHref legacyBehavior>
                <Button
